...
class Addtocart {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Addtocart_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'ADDTOCART_VERSION' ) ) {
			$this->version = ADDTOCART_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	 ...
	 *
	 * - Addtocart_Loader. Orchestrates the hooks of the plugin.
	 * - Addtocart_i18n. Defines internationalization functionality.
	 * - Addtocart_Admin. Defines all hooks for the admin area.
	 * - Addtocart_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		...
		$this->loader = new Addtocart_Loader();
	 ...
	 *
	 * Uses the Addtocart_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Addtocart_i18n();
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Addtocart_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Addtocart_Loader    Orchestrates the hooks of the plugin.
	 */
